...
func TestEventHandler_HandleDeviceUpdatedEmptyOldDevice(t *testing.T) {
	...
	serviceHandler.eventHandler.HandleDeviceUpdatedEvents(ctx, api.DeviceKind, testOrgId, "foo", oldDevice, device, false, nil)
...
func TestEventHandler_DeviceDisconnectedEventDeduplication(t *testing.T) {
	...
	serviceHandler.eventHandler.HandleDeviceUpdatedEvents(ctx, api.DeviceKind, testOrgId, "foo", oldDevice, newDevice, false, nil)
