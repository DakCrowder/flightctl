...
switch_to_local_images() {
    ...
    local services=("api" "api-init" "worker" "periodic" "alert-exporter" "alertmanager-proxy" "alertmanager-proxy-init" "cli-artifacts" "cli-artifacts-init" "db-migrate" "db-wait" "db-users-init")
